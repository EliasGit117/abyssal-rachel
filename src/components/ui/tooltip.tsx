...
function TooltipProvider({ delayDuration = 700, ...props }: ComponentProps<typeof TooltipPrimitive.Provider>) {
  return (
...
function TooltipContent(props: ComponentProps<typeof TooltipPrimitive.Content>) {
  const { className, sideOffset = 0, children, ...tooltipContentProps } = props;
