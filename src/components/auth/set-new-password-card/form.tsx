...
export const setPasswordSchema = z
  ...
  .refine((data) => data.password === data.confirmPassword, {
    ...
    message: m['components.auth.set_new_password_card.passwords_do_not_match']()
  });
              ...
              <Field data-invalid={fieldState.invalid}>
                ...
                <InputGroup>
                  ...
                  <InputGroupAddon align="inline-end">
                    <InputGroupButton
                      size="icon-xs"
                      aria-label={m['components.auth.set_new_password_card.show_passwords']()}
                      title={m['components.auth.set_new_password_card.show_passwords']()}
            ...
            render={({ field, fieldState }) => (
              <Field data-invalid={fieldState.invalid}>
                <FieldLabel htmlFor="confirm-password-input">
                  {m['components.auth.set_new_password_card.confirm_password']()}
                </FieldLabel>
