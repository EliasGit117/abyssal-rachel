...
import { TUpdateCategory } from '@/features/categories/admin/schemas';
...
interface IProps extends Omit<ComponentProps<'form'>, 'onSubmit'> {
  id?: string;
  form: UseFormReturn<TUpdateCategory>;
  onSubmit: (data: TUpdateCategory) => void;
  disabled?: boolean;
  disabledIds?: number[];
}

export const EditCategoryForm: FC<IProps> = ({ form, onSubmit, id, disabled, disabledIds, ...props }) => {
